...
const LandingPage = () => {
	...
	return (
        ...
        `}
			...
			<PageWrapper>
				<Container>
					<Row className="pt-md-5 pb-5 px-1 px-md-0 flex-column-reverse flex-md-row">
						<Col>
							<Stack gap={2}>
								<p>
								...
								<p className="text-justify">
									Request for product loan--, get approved and receive offers with flexible
									repayment options to get your business to the next level.
								</p>
								<Link to="/register">
									<Buttons
										variant="purple"
										size="md"
										className="w-md-25 px-5 mb-3 fw-bold"
										type="button">
										Apply for Loan
									</Buttons>
								</Link>
