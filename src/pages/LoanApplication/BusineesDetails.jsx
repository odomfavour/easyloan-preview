                ...
                <Row className="align-items-center justify-content-between  py-4 flex-column flex-lg-row ">
                        ...
                        <div className="d-flex flex-wrap">
                            ...
                            <Col className='pe-md-4' sm={12} lg={6}>
                                ...
                                <ul className="border w-100 flex-column px-4 mt-3 py-2 bg-white rounded text-secondary  align-items-start d-flex justify-content-start" style={{'width':"auto !important"}}>
                        ...
                        <Form onSubmit={handleSubmitOne}>
                            <Stack gap={5} >
                                ...
                                <Stack className="heading-font " gap={2}>
                                    <Buttons variant="purple" size="md" className="w-100" type="submit" onClick={handleShowTwo} >
                                        Continue
                                    </Buttons>
