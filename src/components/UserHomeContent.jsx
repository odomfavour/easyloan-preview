...
const UserHomeContent = () => {
  return (
    <div>
        <div className='py-5 px-3 user-dash-color user-dashboard-content d-flex justify-content-between'>
            <div>
                <h2>Hello Lydia Salami,</h2>
            </div>
            ...
            <Col sm={12} md={6} className="mb-3 overflow-width">
                <div className='bg-gray px-5 pt-5 user-dashboard-content2' style={{height: "300px"}}>
                    <Row>
                        ...
                        <Col sm={6}>
                            <Button className='user-btn-bg2 shadow-none'>None</Button>
                        </Col>
                    </Row>
